...
public record Message(Long time, String nick, String type, String line, String source) {
  ...
  public static Message fromDocument(final DocumentSnapshot documentSnapshot) {
    return new Message(
            ...
            documentSnapshot.getString("line"),
  ...
  public String toSocketMessage(final String channel) {
    return "PRIVMSG %s :(%s): %s".formatted(channel, nick(), line());
  }
}
